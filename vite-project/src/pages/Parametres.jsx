        ...
        <div className="db">
            ...
            <div className="sidebar">
                ...
                <div className="nav-section">
                    ...
                    <div className="nav-item active" onClick={() => navigate("/parametres")}>
                ...
                <div className="param-body">
                    ...
                    <div className="param-nav">
                        {sections.map((s) => (
                            <div
                                key={s.id}
                                className={`param-nav-item ${sectionActive === s.id ? "active" : ""}`}
                    ...
                    <div className="param-content">
                            ...
                            <>
                                <div className="section-card">
                                    <div className="section-head">
                                        <div className="section-head-icon" style={{ background: "#DCFCE7" }}>
                                            <i className="fa-solid fa-user" style={{ color: "#166534" }}></i>
                                        </div>
                                        <div>
                                            <div className="section-head-title">Informations du compte</div>
                                            <div className="section-head-sub">Modifiez vos informations personnelles</div>
                                        </div>
                                    </div>
                                    <div className="avatar-row">
                                        <div className="big-avatar">JD</div>
                                        <div>
                                            <div className="setting-label">Jean Dupont</div>
                                    ...
                                    <div className="setting-row">
                                        <div>
                                            <div className="setting-label">Nom complet</div>
                                            <div className="setting-desc">Visible par les autres membres</div>
                                        </div>
                                        <input
                                    ...
                                    <div className="setting-row">
                                        <div>
                                            ...
                                            <div className="setting-desc">jean.dupont@email.com</div>
                                        </div>
                                        <button className="setting-btn btn-gray">Modifier</button>
                                    </div>
                                    <div className="setting-row">
                                        <div>
                                            <div className="setting-label">Ville</div>
                                            <div className="setting-desc">Antananarivo, Madagascar</div>
                                        </div>
                                        <button className="setting-btn btn-gray">Modifier</button>
                                    </div>
                                    <div className="setting-row">
                        ...
                        {sectionActive === "notifications" && (
                            <div className="section-card">
                                <div className="section-head">
                                    <div className="section-head-icon" style={{ background: "#DBEAFE" }}>
                                        <i className="fa-solid fa-bell" style={{ color: "#1e40af" }}></i>
                                    </div>
                                    <div>
                                        <div className="section-head-title">Notifications</div>
                                        <div className="section-head-sub">Choisissez ce que vous souhaitez recevoir</div>
                                    </div>
                                </div>
                                {[
                        ...
                        {sectionActive === "securite" && (
                            <div className="section-card">
                                <div className="section-head">
                                    <div className="section-head-icon" style={{ background: "#FEF9C3" }}>
                                        <i className="fa-solid fa-lock" style={{ color: "#854d0e" }}></i>
                                    </div>
                                    <div>
                                        <div className="section-head-title">Sécurité</div>
                                        <div className="section-head-sub">Protégez votre compte</div>
                                    </div>
                                </div>
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Mot de passe</div>
                                        <div className="setting-desc">Dernière modification il y a 3 mois</div>
                                    </div>
                                    <button className="setting-btn btn-gray">Changer</button>
                                </div>
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Double authentification</div>
                                        <div className="setting-desc">Sécurité renforcée pour votre compte</div>
                                    </div>
                                    <div
                                        className={`toggle ${doubleAuth ? "on" : ""}`}
                                ...
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Sessions actives</div>
                                        <div className="setting-desc">1 session — Windows · Chrome</div>
                                    </div>
                                    <button className="setting-btn btn-red">Déconnecter tout</button>
                                </div>
                            </div>
                        )}
                        ...
                        {sectionActive === "apparence" && (
                            <div className="section-card">
                                <div className="section-head">
                                    <div className="section-head-icon" style={{ background: "#EDE9FE" }}>
                                        <i className="fa-solid fa-palette" style={{ color: "#5b21b6" }}></i>
                                    </div>
                                    <div>
                                        <div className="section-head-title">Apparence</div>
                                        <div className="section-head-sub">Personnalisez l'interface</div>
                                    </div>
                                </div>
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Thème</div>
                                        <div className="setting-desc">Clair, sombre ou automatique</div>
                                    </div>
                                    <select
                                ...
                                <div className="setting-row">
                                    <div>
                                        ...
                                        <div className="setting-desc">Langue de l'interface</div>
                                    </div>
                                    <select
                                        className="setting-select"
                                        value={langue}
                        ...
                        {sectionActive === "danger" && (
                            <div className="danger-zone">
                                ...
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Désactiver mon compte</div>
                                        <div className="setting-desc">Votre compte sera suspendu temporairement</div>
                                    </div>
                                    <button className="setting-btn btn-red">Désactiver</button>
                                </div>
                                <div className="setting-row">
                                    <div>
                                        <div className="setting-label">Supprimer mon compte</div>
                                        <div className="setting-desc">Toutes vos données seront définitivement supprimées</div>
                                    </div>
